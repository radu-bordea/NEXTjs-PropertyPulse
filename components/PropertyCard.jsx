...
// Card component to display brief info about a property listing
const PropertyCard = ({ property }) => {
  // Function to get the most appropriate rent rate
  ...
  return (
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        ...
        {/* Pricing options shown for styling only (not dynamic) */}
